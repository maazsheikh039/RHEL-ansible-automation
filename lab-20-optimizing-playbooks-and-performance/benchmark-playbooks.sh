...
run_benchmark "large-playbook.yml" "Original Monolithic Playbook" 2
run_benchmark "optimized-playbook.yml" "Role-based Optimized Playbook" 2
run_benchmark "async-optimization.yml" "Asynchronous Execution Playbook" 2
